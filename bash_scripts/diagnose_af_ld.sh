...
#SBATCH --job-name=xpop_af_ld
#SBATCH --array=0-9
#SBATCH --output=logs/af_ld_%A_%a.out
#SBATCH --error=logs/af_ld_%A_%a.err
...
TARGET="experiments/${MODEL}/vae/${SIM_NUMBER}/rep${REPLICATE}/${EXP_ID}/diagnostics/allelefreq_vs_ld_discovery_val/balanced_accuracy_vs_maf.png"
