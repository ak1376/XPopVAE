...
#SBATCH --job-name=xpop_ld_tgheld
#SBATCH --array=0-9
#SBATCH --output=logs/ld_tgheld_%A_%a.out
#SBATCH --error=logs/ld_tgheld_%A_%a.err
...
TARGET="experiments/${MODEL}/vae/${SIM_NUMBER}/rep${REPLICATE}/${EXP_ID}/diagnostics/ld_decay_target_held_out/ld_decay_truth_vs_reconstructed.png"
